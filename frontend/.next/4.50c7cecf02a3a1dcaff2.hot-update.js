...
function (_React$Component) {
  ...
  function VegaChart(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "updateChart", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        _this.generateData().then(function (data) {
          spec.data = data;
...
//# sourceMappingURL=4.50c7cecf02a3a1dcaff2.hot-update.js.map