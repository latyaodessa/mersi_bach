...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "generateCharts", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        for (var i = 0; i < _this.state.charts; i++) {
          return _react.default.createElement("div", {
            ...
            randomise: _this.state.randomise,
            changeRandomise: _this.changeRandomise,
            __source: {
              fileName: _jsxFileName,
              lineNumber: 29
            }
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      }, "A Primary Button")), _react.default.createElement("div", {
        className: "pure-u-1-3",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 43
...
//# sourceMappingURL=4.b9f56e85d9b27448bdff.hot-update.js.map